...
{
    public class DiveHard
    {
        private IContentParser _contentParser;
        private IList<Command> _commands = new List<Command>();

        public string Name => "Dive! hard";

        public DiveHard(IContentParser contentParser)
        {
        ...
        public long Run()
        {
            ...
            _contentParser.GetLines("Task.txt").ForEach(line => _commands.Add(parser.Create(line, true)));
